  ...
  return (
    <div className="celebration-container animate-fade-in">
      <header className="celebration-header">
        <h1 className="text-gradient animate-float">Happy Birthday!</h1>
      </header>

      <section className="message-section glass-panel delay-300 animate-fade-in">
        <h2 className="message-title text-gradient">To my prettiest girl, Malshi Charuka,</h2>
        <div className="message-content">
          <p className="message-body">
            Happy Birthday! I just wanted to let you know how much I appreciate having you in my life. You bring so much happiness and light wherever you go, and I feel so lucky to be celebrating another year with you. 
          </p>
          <p className="message-body">
      ...
      <section className="carousel-section delay-700 animate-fade-in">
        <h3 className="carousel-title">Our Beautiful Memories</h3>
        <PhotoCarousel />
      </section>
    </div>
  );
