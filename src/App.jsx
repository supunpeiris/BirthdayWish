...
import SurpriseCollage from './components/SurpriseCollage'
import Wishes          from './components/Wishes'
import Feedback        from './components/Feedback'
import Confetti        from './components/Confetti'
import './App.css'

const SECTIONS = ['cover', 'message', 'gallery', 'surprise', 'wishes', 'feedback']
  ...
  return (
    <main className="app-container">
      ...
      <div className="content-layer">
        ...
        {sectionIdx === 2 && <PhotoCollage onNext={() => goTo(3)} />}
        {sectionIdx === 3 && <SurpriseCollage onNext={() => goTo(4)} />}
        {sectionIdx === 4 && <Wishes onNext={() => goTo(5)} />}
        {sectionIdx === 5 && <Feedback onRestart={() => goTo(0)} />}
      </div>
